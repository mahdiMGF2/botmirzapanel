...
$textbotlang['Admin']['cron']['active_manual'] = "📝 بدلیل غیرفعال بودن تابع shell_exe باید کرون ها بطور دستی  فعال نمایید می توانید از هاست یا سایت های که کار کرون انجام می دهند این کار را انجام دهید.
...
<blockquote>%s</blockquote>";
$textbotlang['Admin']['cron']['active_manual_card'] = "جهت فعالسازی تایید خودکار بدون بررسی بدلیل غیرفعال بودن تابع shell_exe باید کرون را بصورت دستی انجام دهید.

جهت تنظیم می توانید از کامند زیر استفاده کنید

<blockquote>%s</blockquote>";
$textbotlang['Admin']['cron']['active_manual_sendmessage'] = "جهت فعالسازی  بخش ارسال پیام بدلیل غیرفعال بودن تابع shell_exe باید کرون را بصورت دستی انجام دهید.
