...
$textbotlang['users']['Balance']['transaction_created'] = "✅ تراکنش شما ایجاد شد";
$textbotlang['users']['Balance']['tracking_code'] = "🛒 کد پیگیری:";
$textbotlang['users']['Balance']['network'] = "🌐 شبکه:";
$textbotlang['users']['Balance']['wallet_address'] = "💳 آدرس ولت:";
$textbotlang['users']['Balance']['amount_trx'] = "💲 مبلغ تراکنش به ترون:";
$textbotlang['users']['Balance']['amount_toman'] = "💲 مبلغ تراکنش به تومان:";
$textbotlang['users']['Balance']['trx_rate'] = "💲 نرخ ترون:";
$textbotlang['users']['Balance']['payment_error_admin'] = "⭕️ یک کاربر قصد پرداخت داشت که ساخت لینک پرداخت  با خطا مواجه شده و به کاربر لینک داده نشد\n✍️ دلیل خطا : %s\n\nآیدی کابر : %s\nنام کاربری کاربر : @%s";
$textbotlang['users']['Balance']['payment_instructions'] = "📌 مبلغ %s تومان بعد از تایید پرداخت توسط شبکه بلاکچین به کیف پول شما اضافه میشود\n\n💢 لطفا به این نکات قبل از پرداخت توجه کنید 👇\n\n🔸 در صورت اشتباه وارد کردن آدرس کیف پول، تراکنش تایید نمیشود و بازگشت وجه امکان پذیر نیست\n🔹 مبلغ ارسالی نباید کمتر و یا بیشتر از مبلغ اعلام شده باشد.\n🔸 کارمزد تراکنش باید از سمت کاربر پرداخت شود و باید دقیقا مبلغی که اعلام شده ارسال شود.\n🔹 در صورت واریز بیش از مقدار گفته شده، امکان اضافه کردن تفاوت وجه وجود ندارد.\n🔸 هر کیف پول فقط برای یک تراکنش قابل استفاده است و درصورت ارسال مجدد ارز امکان برگشت وجه نیست.\n🔹 هر تراکنش بین 10 دقیقه الی  15 دقیقه  معتبر است .\n\n✅ در صورت مشکل میتوانید با پشتیبانی در ارتباط باشید";
